...
@interface ResouceSelectController ()

@end

@implementation ResouceSelectController
...
- (void)selectBthClick:(UIButton *)button
{
    ...
    {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"moneyResouceNature" object:nil userInfo:dic];
