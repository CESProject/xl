...
@interface PartnerTypeViewController ()

@end

@implementation PartnerTypeViewController
...
- (void)selectBthClick:(UIButton *)button
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"callPartner" object:nil userInfo:dic];
