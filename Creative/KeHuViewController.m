...
//  Creative
//
//  Created by huahongbo on 16/2/26.
//  Copyright © 2016年 王文静. All rights reserved.
//

#import "KeHuViewController.h"

@interface KeHuViewController ()<UIWebViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIWebView *web = [common creatWebViewUrlName:self.urlCont control:self frame:CGRectMake(0, 0, DEF_SCREEN_WIDTH, DEF_SCREEN_HEIGHT)];
    web.delegate = self;
}
