...
@interface PhaseColViewController ()

@end

@implementation PhaseColViewController
...
- (void)selectBthClick:(UIButton *)button
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"partnerJieDuan" object:nil userInfo:dic];
