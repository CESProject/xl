...
@interface PersonNumViewController ()

@end

@implementation PersonNumViewController
...
- (void)selectBthClick:(UIButton *)button
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"personNumbers" object:nil userInfo:dic];
